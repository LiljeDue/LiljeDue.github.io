...
viewHome _ =
    div [ class "content-display" ]
        ...
        , p []
            [ text "I am Lilje Henrich Due, a PhD student in the "
            , pltc
            , text " section at "
            , diku
            , text ", supervised by "
        ...
        , div [ class "links-section" ]
            [ div
                [ class "links-icons" ]
                [ a [ href "mailto:due@di.ku.dk", class "links-link" ]
                    [ img [ src "content/icons/email.svg", alt "Email", class "links-icon" ] []
                    , span [] []
                    ]
                , a [ href "https://github.com/LiljeDue", target "_blank", class "links-link" ]
                    [ img [ src "content/icons/github.svg", alt "GitHub", class "links-icon" ] []
                    , span [] []
                    ]
                , a [ href "https://linkedin.com/in/lilje-henrich-due-177937152", target "_blank", class "links-link" ]
